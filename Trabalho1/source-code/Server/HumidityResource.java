...
public class HumidityResource extends CoapResource {
	...
	// Constructor
	public HumidityResource(String name, SensorDHT11 sensor) {
		
		// Define resource name
		super(name);
		sensorDHT11 = sensor;
		
		// Create a Timer object to Humidity readings each 3 seconds
	...
	private class UpdateTask extends TimerTask {
		...
		@Override public void run() {
			String newMeasure = sensorDHT11.getHumidity();
